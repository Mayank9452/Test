...
export default function Leaderboard({
  ...
  return (
    ...
    `}
      ...
      transition-colors
      ${activeTab === "weekly" ? "text-black gradient-light" : "text-white"}
    `}
        >
          Weekly
        </button>
        ...
        <button
          ...
          className={`relative z-10 px-5 py-1.5 text-sm font-bold rounded-lg
      transition-colors
      ${activeTab === "monthly" ? "text-black gradient-light" : "text-white"}
    `}
        >
          Monthly
        </button>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="pushable w-1/3">
          ...
          <span className="front gradient-light text-black py-2 rounded-xl text-sm">
            View All
          </span>
        </button>
      </div>
